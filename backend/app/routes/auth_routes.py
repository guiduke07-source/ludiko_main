...
# Rotas Públicas de Login, Cadastro e Recuperação de Senha
...
auth_bp.post("/solicitar-codigo-senha")(AuthController.solicitar_codigo_recuperacao)
auth_bp.post("/redefinir-senha-codigo")(AuthController.redefinir_senha_com_codigo)
