...
class App {
  ...
  onTouchUp(e) {
    ...
    const distX = Math.abs(clientX - this.clickStartX);
    const distY = Math.abs(clientY - this.clickStartY);

    if (timeDiff < 250 && distX < 7 && distY < 7) {
  ...
  handleClick(clientX, clientY) {
    ...
    const clickX3D = (mouseX * this.viewport.width) / 2;
    const clickY3D = (mouseY * this.viewport.height) / 2;
